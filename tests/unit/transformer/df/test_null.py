...
def test_null_column_dataframe_transformer_transform_threshold_0_4() -> None:
    ...
    dataframe = transformer.transform(dataframe)
    assert_frame_equal(
        dataframe, pd.DataFrame({"col1": ["2020-1-1", "2020-1-2", "2020-1-31", "2020-12-31", None]})
    )
...
def test_null_column_dataframe_transformer_transform_empty_row() -> None:
    ...
    assert_frame_equal(dataframe, pd.DataFrame({"col1": [], "col2": [], "col3": []}))
